            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src={getImagePath("/images/logo/blackLogo.svg")}
                    alt="logo"
                    className="w-full h28 dark:hidden"
                    width={140}
                    height={30}
                  />
                  <Image
                    src={getImagePath("/images/logo/whiteLogo.svg")}
                    alt="logo"
                    className="hidden h28 w-full dark:block"
                    width={140}
                    height={30}
                  />
                </Link>
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Smart financial solutions for modern businesses and individuals. Simplify banking, payments, and investments with secure and innovative fintech tools.
                </p>
        ...
        <div className="h-px w-full bg-gradient-to-r from-transparent via-[#D2D8E183] to-transparent dark:via-[#959CB183]">
          <div className="py-4">
            <p className="text-center text-base text-body-color dark:text-white">
              © 2025 FinTechX. All rights reserved.
            </p>
          </div>
        </div> 
        </div>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#00598a" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#00598a" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
